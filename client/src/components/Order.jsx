...
const OrderCard = ({ platform, product, price, deliveryDate, status }) => {
  const badgeColor = statusColors[status] || statusColors.default;
  return (
    <div className="bg-gradient-to-br from-blue-50 to-purple-100 shadow-lg rounded-xl p-5 border border-gray-200 hover:shadow-xl transition-shadow duration-200">
